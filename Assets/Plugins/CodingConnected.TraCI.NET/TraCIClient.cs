...
namespace CodingConnected.TraCI.NET
{
    ...
    public class TraCIClient : IDisposable
    {
	    ...
	    private ChargingStationCommands _chargingstation;
	    ...
	    public ChargingStationCommands ChargingStation => _chargingstation ?? (_chargingstation = new ChargingStationCommands(this));
		    ...
		    try
		    {
                ...
                if (bytesRead != totlength)
                {
                    while (bytesRead < totlength)
                    {
                        ...
                        {
                            //print("TraCI took too long to respond");
                            break;
                        }
                    }
                    sw.Stop();
